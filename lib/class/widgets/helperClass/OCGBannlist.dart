...
class OCGBannedCardList extends StatelessWidget {
  final CardData _cardData = CardData();

  OCGBannedCardList({super.key});

  @override
  Widget build(BuildContext context) {
    final Future<Map<String, List<dynamic>>> sortedCards = _cardData
        .sortOCGBannCards();
              ...
              return ListView(
                children: [
                  ...
                  if (semiLimited.isNotEmpty) ...[
                    _buildSectionHeader('Semi-limited', Colors.green.shade300),
                    _buildSectionContainer(
